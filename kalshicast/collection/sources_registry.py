"""Dynamic collector loader — validates payload shape.

Ported from sources_registry.py with updated module paths.
"""
...
def load_fetchers_safe() -> Dict[str, Fetcher]:
    """Load enabled sources and return source_id -> fetcher(station) -> payload dict.
